  ...
  public final java_cup.runtime.Symbol CUP$TestLangParser$do_action_part00000000(
    ...
    throws java.lang.Exception
    {
      ...
      RESULT = a;
		...
		int pathright = ((java_cup.runtime.Symbol)CUP$TestLangParser$stack.elementAt(CUP$TestLangParser$top-1)).right;
		String path = (String)((java_cup.runtime.Symbol) CUP$TestLangParser$stack.elementAt(CUP$TestLangParser$top-1)).value;
		int eleft = ((java_cup.runtime.Symbol)CUP$TestLangParser$stack.peek()).left;
		int eright = ((java_cup.runtime.Symbol)CUP$TestLangParser$stack.peek()).right;
		Object e = (Object)((java_cup.runtime.Symbol) CUP$TestLangParser$stack.peek()).value;
     ...
     //System.out.println("  → 1 statement parsed");
      ...
      RESULT = Assertion.status(Integer.parseInt(code));
          ...
          case 22: // assertion ::= EXPECT STATUS EQUALS error SEMICOLON 
            {
              Assertion RESULT =null;
		int eleft = ((java_cup.runtime.Symbol)CUP$TestLangParser$stack.elementAt(CUP$TestLangParser$top-1)).left;
		int eright = ((java_cup.runtime.Symbol)CUP$TestLangParser$stack.elementAt(CUP$TestLangParser$top-1)).right;
		Object e = (Object)((java_cup.runtime.Symbol) CUP$TestLangParser$stack.elementAt(CUP$TestLangParser$top-1)).value;
      ...
      //System.out.println("📌 Variable: " + RESULT);
          ...
          case 31: // variable_decl ::= LET NUMBER 
            {
              Variable RESULT =null;
		int badleft = ((java_cup.runtime.Symbol)CUP$TestLangParser$stack.peek()).left;
		int badright = ((java_cup.runtime.Symbol)CUP$TestLangParser$stack.peek()).right;
		String bad = (String)((java_cup.runtime.Symbol) CUP$TestLangParser$stack.peek()).value;
		
      parser.report_error("expected IDENT after 'let'", bad);
    
              CUP$TestLangParser$result = parser.getSymbolFactory().newSymbol("variable_decl",9, ((java_cup.runtime.Symbol)CUP$TestLangParser$stack.elementAt(CUP$TestLangParser$top-1)), ((java_cup.runtime.Symbol)CUP$TestLangParser$stack.peek()), RESULT);
            }
          return CUP$TestLangParser$result;
